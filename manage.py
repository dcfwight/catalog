...
# started is tedious work. To avoid having to constanly repeat these imports, the
# Flask-Script's shell cmmmand can be configured to import certain objects
# To add objects tot he import list, the shell command needs to be registered
