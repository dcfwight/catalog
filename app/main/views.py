...
GOOGLE_CLIENT_ID = json.loads(open(__dir__ +'/app/main/google_client_secret.json', 'r')
	.read())['web']['client_id']
...
def show_catalog():
	...
	categories = session.query(Category).order_by(db.func.lower(Category.name))
...
@main.route('/catalog/<string:category>/items', methods=['GET'])
...
@main.route('/catalog/<string:category>/<string:item>', methods=['GET'])
...
@main.route('/createItem/', methods=['GET','POST'])
...
@main.route('/<string:category>/createItem/', methods=['GET', 'POST'])
...
@main.route('/<string:category>/edit/', methods=['GET', 'POST'])
...
@main.route('/<string:category>/delete/', methods=['GET', 'POST'])
...
@main.route('/<string:category_name>/<string:item_name>/edit_item/',
		   methods=['GET', 'POST'])
...
@main.route('/<string:category_name>/<string:item_name>/deleteItem/',
		   methods=['GET', 'POST'])
...
def gconnect():
	...
	try:
		...
		oauth_flow = flow_from_clientsecrets(__dir__ +'/app/main/google_client_secret.json',
											 scope='')
...
@main.route('/fbconnect', methods=['POST'])
def fbconnect():
...
@main.route('/api/v1.0/<string:category>/<string:item>', methods=['GET'])
